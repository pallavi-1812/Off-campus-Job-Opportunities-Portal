  ...
  return (
    <Grid className={classes.filterDiv}>
      <Grid>
        ...
        <FormGroup>
          <FormControlLabel control={<Checkbox color="primary" inputProps={{ "aria-label": "secondary checkbox" }} />} label="Full Time" />
          <FormControlLabel control={<Checkbox color="primary" inputProps={{ "aria-label": "secondary checkbox" }} />} label="Part Time" />
          <FormControlLabel control={<Checkbox color="primary" inputProps={{ "aria-label": "secondary checkbox" }} />} label="Internships" />
          <FormControlLabel control={<Checkbox color="primary" inputProps={{ "aria-label": "secondary checkbox" }} />} label="Remote" />
        </FormGroup>
      </Grid>
      ...
      <Grid className={classes.postedByGrid}>
        ...
        <FormGroup>
          <FormControlLabel control={<Checkbox color="primary" inputProps={{ "aria-label": "secondary checkbox" }} />} label="TPC" />
          <FormControlLabel control={<Checkbox color="primary" inputProps={{ "aria-label": "secondary checkbox" }} />} label="Other websites" />
        </FormGroup>
      </Grid>
